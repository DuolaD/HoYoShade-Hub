...
public sealed partial class ReShadeDownloadView : UserControl
{
    ...
    // Logic:
    // - If only one framework is installed ¡ú only that framework's option is enabled
    // - If both frameworks are installed ¡ú all options enabled initially, then disable after installation
