...
public class GameId : IEquatable<GameId>
{
    ...
    public static GameId? FromGameBiz(GameBiz gameBiz)
    {
        return gameBiz.Value switch
        {
            ...
            GameBiz.hyg_cn => new GameId { Id = "ERYDdvf0w8", GameBiz = "hyg_cn" },
            GameBiz.hyg_global => new GameId { Id = "viiywh5G2H", GameBiz = "hyg_global" },
            GameBiz.hyg_cbt1 => new GameId { Id = "hyg_cbt1", GameBiz = "hyg_cbt1" },
            GameBiz.abc_cn => new GameId { Id = "m8TGERqknS", GameBiz = "abc_cn" },
            GameBiz.abc_global => new GameId { Id = "yneO4yGc4x", GameBiz = "abc_global" },
            GameBiz.abc_cbt1 => new GameId { Id = "abc_cbt1", GameBiz = "abc_cbt1" },
